...
function BrandVoice() {
  ...
  const data = [
    {
      brandVoice: 'profesional, inovatif, dan solutif, dengan bahasa yang sederhana dan mudah dipahami, serta fokus pada kepercayaan, kemudahan, dan masa depan yang lebih baik melalui teknologi.'
    }
  ]
          ...
          !startDateKPI || !endDateKPI ?
            ...
            <div className='rounded-2xl p-2 border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]'>
              <div className='bg-white flex justify-center dark:border-gray-800 dark:bg-white/[0.03] my-5'>
                {/* form input brand voice */}
                <div className='w-3/5 mx-2 border border-gray-200 rounded-2xl'>
                  <div className='py-5 mx-5 font-bold text-lg text-center'>
                    <label>Brand Voice Form</label>
                  </div>
                  <div className='border-t border-gray-200 py-6 px-6'>
                    <div className='mt-3'>
                      <label className='mb-1.5 block text-base font-medium text-gray-700 dark:text-gray-400'>Brand Voice</label>
                      <input
                        placeholder='Masukkan brand voice data'
                ...
                {/* section tampil brand voice */}
                <div className='w-3/5 mx-2 border border-gray-200 rounded-2xl'>
                  <div className='py-5 mx-5 font-bold text-lg text-center'>
                    <label>List Brand Voice</label>
                  </div>
                  <div className='border-t border-gray-200 py-6 px-6'>
                        ...
                        <div className='overflow-x-auto border border-gray-200 rounded-lg max-h-[200px] overflow-y-auto'>
                          <table className='min-w-full divide-y divide-gray-100 dark:divide-white/[0.05]'>
                            <thead className='bg-gray-50 dark:bg-white/[0.02]'>
                              <tr>
                                <th className='px-5 py-3 font-medium text-gray-500 text-center text-theme-xs dark:text-gray-400 whitespace-nowrap'>
                                  No
                                </th>
                                <th className='px-5 py-3 font-medium text-gray-500 text-center text-theme-xs dark:text-gray-400 whitespace-nowrap'>
                                  Brand Voice
