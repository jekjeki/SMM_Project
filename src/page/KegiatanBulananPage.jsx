...
function KegiatanBulananPage() {
  ...
  const data = [
    {
      checked: true,
      target: '15 Upload dalam sebulan'
    },
    {
      checked: false,
      target: 'Artikel'
  ...
  // monthly report click submit 
  const submitTargetClick = () => {
    Swal.fire({
      title: 'Success input target or KPI data!', 
      text: 'success insert target or KPI data', 
      icon: 'success' 
    })
  }
            ...
            <>
              <div className='rounded-2xl p-2 border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]'>
                <div className='bg-white flex justify-center dark:border-gray-800 dark:bg-white/[0.03] my-5'>
                  {/* box untuk input kegiatan bulanan */}
                  <div className='w-3/5 mx-2 border border-gray-200 rounded-2xl'>
                    <div className='py-5 mx-5 font-bold text-lg text-center'>
                      <label>Monthly Activity Report</label>
                    </div>
                    <div className='border-t border-gray-200 py-6 px-6'>
                      <div className='mt-3'>
                        <label className='mb-1.5 block text-base font-medium text-gray-700 dark:text-gray-400'>Monthly Activity</label>
                        <input
                      ...
                      <div className='mt-3 flex justify-end'>
                        <button
                        onClick={submitTargetClick}
                        className='bg-blue-500 text-white hover:bg-blue-800'>Submit</button>
                      </div>
                    </div>
                  </div>
                  {/* box untuk list activity serta siapin checkbox */}
                  <div className='w-3/5 mx-2 border border-gray-200 rounded-2xl'>
                    <div className='py-5 mx-5 font-bold text-lg text-center'>
                      <label>List Target Activity</label>
                    </div>
                    <div className='border-t border-gray-200 py-6 px-6'>
...
export default KegiatanBulananPage