...
function TargetHasilPage() {
  ...
  const data = [
    ...
    {
      checked: false,
      target: 'kata pencarian di social media'
    }
  ]
                ...
                <div className='w-3/5 mx-2 border border-gray-200 rounded-2xl'>
                  ...
                  <div className='border-t border-gray-200 py-6 px-6'>
                    <div className='mt-3'>
                      ...
                      <input
                        placeholder='masukkan target hasil'
...
export default TargetHasilPage