                                ...
                                <div className='w-3/5 mx-2 border border-gray-200 rounded-2xl'>
                                    ...
                                    <div className='border-t border-gray-200 py-6 px-6'>
                                        <div className='mt-3'>
                                            ...
                                            <input
                                                placeholder='Masukkan Color Code'
                                                        ...
                                                        <tbody>
                                                            {
                                                                currentItems.map((item, idx) => (
                                                                    <tr key={idx}>
                                                                        ...
                                                                        <td className='flex items-center px-5 py-4 text-gray-500 dark:text-gray-400 whitespace-nowrap'>
                                                                            ...
                                                                            className='w-[10px] h-[10px] border mx-2'>
